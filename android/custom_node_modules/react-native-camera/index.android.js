...
var ReactCameraViewWrapper = React.createClass({
    ...
    saveVideo (path, options, callback) {
        var component = this;
        var defaultOptions = {
            type: component.props.type,
            target: component.props.captureTarget,
            mode: component.props.captureMode,
            sampleSize: 0,
            title: '',
            description: '',
            path: path
        ...
        return new Promise(function(resolve, reject) {
            ...
            ReactNativeCameraModule.saveFiles(Object.assign(defaultOptions, options || {}), function(videoURL, imageURL) {
                var obj = {
                    videoURL: videoURL,
                    imageURL: imageURL
                }
    ...
    captureVideo (options, callback) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            ReactNativeCameraModule.captureVideo(Object.assign(defaultOptions, options || {}), function(encoded) {
