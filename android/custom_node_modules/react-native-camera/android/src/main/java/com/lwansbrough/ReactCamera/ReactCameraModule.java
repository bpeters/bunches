...
public class ReactCameraModule extends ReactContextBaseJavaModule {
    ...
    private static File firstFrame(String path) {
        File imageFile = new File(Environment.getExternalStorageDirectory(),"first.jpg");
    ...
    @ReactMethod
    public void saveFiles(ReadableMap options, final Callback callback) {

        File file = new File(options.getString("path"));

        File firstFrame = firstFrame(options.getString("path"));
        ...
        String fileNameVideo = "videos/bunches-" + formattedDate + ".mp4";

        String fileNameFrame = "firstFrames/bunches-" + formattedDate + ".png";
        ...
        callback.invoke(fileNameVideo,fileNameFrame);
